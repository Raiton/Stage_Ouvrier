...
\caption{Transformteurs de la centrale}
...
Dans l'osmoseur inverse, l'eau passe par 9 tubes contenant chacun 7 membranes et subit le phénomène d'osmose inverse. A sa sortie, on obtient de l'eau douce à 1000 \conduct.
...
Le processus d'osmose inverse reprend dans l'osmoseur secondaire. Ce dernier est constitué de deux étages contenant deux et un osmoseurs respectivement.
